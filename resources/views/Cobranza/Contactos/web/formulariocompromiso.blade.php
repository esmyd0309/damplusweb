...
<div class="container">
        ...
        <div  class="col" md="4">
          <div class="input-group">
            <div class="input-group-prepend">
                ...
                <select class="custom-select form-control"  name="contacto" required>
      ...
      <div  class="col" md="4">
        <div class="input-group">
          <div class="input-group-prepend">
            ...
            <select class="custom-select form-control"  name="formapago" required>
    ...
    <div class="row">
        <div class="col">
          <div class="input-group">
            <div class="input-group-prepend">
                <label class="input-group-text" >Compromiso</label>
            </div>

                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-sm"> 
                                                    <div class="form-group">
                                                        {{ form::label('estadolab', 'Estado Economico') }}
                                            ...
                                            <div class="row">
                                                <div class="col-sm"> 
                                                    <div class="form-group">
                                                        {{ form::label('contesta', 'Contesta') }}
                                                        {{ Form::checkbox('contesta', '1', true) }}
                                                    </div>
                                                </div>
                                                <div class="col-sm"> 
                                                    <div class="form-group">
                                                        {{ form::label('contesta', 'No contesta') }}
                                                        {{ Form::checkbox('contesta', '0', false) }}
                                                    </div>
                                                </div>
                                           
                                                <div class="col-sm"> 
                                                        <div class="form-group">
                                                            {{ form::label('estadoclientes', 'Estado Cliente') }}
                                                            {!! Form::select('estadoclientes', [null => 'Seleccione Estado'] + ['Al Dia' => 'Al Dia','Recuperado '=>'Recuperado','Intermitente'=>'Intermitente','Vencido'=>'Vencido'], null, ['class' => 'form-control']) !!}
                                                        </div>
                                                    </div>
                                            </div>
                                                <div class="row">
                                                <div class="col-sm"> 
                                                    <div class="form-group">
                                                        {{ form::label('pagar', 'No Desea Pagar') }}
                                                        {!! Form::select('pagar', [null => 'Seleccione Estado'] + ['Quiere Pagar' => 'Quiere Pagar','No Quiere Pagar '=>'No Quiere Pagar ','Quiere No Puede'=>'Quiere No Puede'], null, ['class' => 'form-control']) !!}
                                                    </div>
                                                </div>
                                                <div class="col-sm">
                                                    <div class="form-group">
                                                        {{ form::label('observacionestadocliente', 'Observación') }}
                                                        {{ form::text('observacionestadocliente', null, ['class' => 'form-control','maxlength'=> '255','minlength'=> '9']) }}
                                                    </div>   
                                                </div>
                                            </div>
                    </div>

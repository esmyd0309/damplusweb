    ...
    <div class="sidebar">
      ...
      @if(Auth::user())
        ...
        <nav class="mt-2">
          ...
          <li class="nav-item">
              <a href="{{ route('gestionesact') }}" class="nav-link">
              ...
              <li class="nav-item">
                <a href="{{ route('logpredictivo') }}" class="nav-link">
                  <i class="nav-icon fas fa-phone-volume"></i>
                  <strong><p>Historico Telefonos</p></strong>
                  <span class="right badge badge-danger">New</span>
                </a>
              </li>
        ...
        @can('agenda.index')    
        <!--<li class="nav-item">
          <a href="{{ route('ventasgrupos') }}" class="nav-link">
            <i class="far fa-circle nav-icon"></i>
            <p>Grupo</p>
          </a>
        </li>-->
        ...
        @can('manuales.index')    
        <li class="nav-item">
          <a href="{{ route('manuales.index') }}" class="nav-link">
            <i class="far fa-circle nav-icon"></i>
            <p>Manuales</p>
          </a>
        </li>
        ...
        @can('rechazos.index')    
        <li class="nav-item">
          <a href="{{ route('rechazos.index') }}" class="nav-link">
            <i class="far fa-circle nav-icon"></i>
            <p>Rechazos</p>
          </a>
        </li>
